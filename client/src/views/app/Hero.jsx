...
export default () => {
    ...
    return (
        <div className='relative'>
            <div className='absolute inset-0 blur-xl h-[580px]' style={{ background: "linear-gradient(143.6deg, rgba(192, 132, 252, 0) 20.79%, rgba(0, 128, 128, 0.26) 40.92%, rgba(204, 171, 238, 0) 70.35%)" }}></div>
            ...
            <div className='relative'>
                        ...
                        <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
                            ...
                            <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
                                <ul className="flex-1 justify-center items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                                    {
                                        navigation.map((item, idx) => {
                                            return (
                                                <li key={idx} className="text-gray-700 cursor-pointer hover:text-gray-900">
                                                    <Link smooth={true} to={item.path} className="block">
                                                        {item.title}
                                                    </Link>
                                                </li>
                                            )
                                ...
                                <div className="items-center justify-end mt-6 space-y-6 md:flex md:mt-0">
                                    <NavLink to="/login" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex">
                                        Sign in
                ...
                <section>
                    <div className="max-w-screen-xl mx-auto px-4 md:py-28 gap-12 text-gray-600 overflow-hidden md:px-8 md:flex">
                        <div className='flex-none space-y-5 max-w-xl'>
                            <a href="javascript:void(0)" className='inline-flex gap-x-6 items-center rounded-full p-1 pr-6 border text-sm font-medium duration-150 hover:bg-white'>
                                <span className='inline-block rounded-full px-3 py-1 bg-teal-600 text-white'>
                                    News
                                </span>
